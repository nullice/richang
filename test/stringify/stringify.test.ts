...
describe("toJson", () => {
    test("普通对象", () => {
        ...
        let re = <any>rc.stringify.toJson(ob, 0)
    ...
    test("Circular", () => {
        ...
        let re = <any>rc.stringify.toJson(ob, 4)
        // console.log(re)
...
describe("fromJson", () => {
    ...
    test("Circular circularReappear", () => {
        let obC: any = { name: "obC", a: 1 }
        let obCC: any = { name: "obCC", b: 2 }
        obCC.obC = obC
        obC.obC = obCC
        ...
        let reJson = <any>rc.stringify.toJson(ob, 4, true)
        ...
        // circular ob  => circular json
        let reReJson = <any>rc.stringify.toJson(reOb, 4, true)
