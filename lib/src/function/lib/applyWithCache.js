 ...
 * @return {any}
 */
export function applyWithCache(func, thisArg, args, cacheOptions) {
    if (cache_funcs === undefined)
        cache_funcs = new KeyValueCache();
    let funcCache = cache_funcs.get(func);
...
//# sourceMappingURL=applyWithCache.js.map