 ...
 * @return {string}
 */
export function genUUID_v5(name, namespace = "f8061fba-842b-4cc5-9872-9348e2e06916") {
    // 如果命名空间不是 UUID ，给定默认 UUID 生成一个命名空间的 UUID
    if (namespace.length !== 36)
        namespace = uuidv5(namespace, "f8061fba-842b-4cc5-9872-9348e2e06916");
 ...
 * @returns {string}
 */
export function rollString(length, dict = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789") {
    let text = "";
    const possible = dict;
