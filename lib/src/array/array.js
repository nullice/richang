 ...
 * @return {any}
 */
export function arraySymDifference(a, b, equalMethod) {
    let hash = get2ArrayOverlapMap(a, b, equalMethod);
    let re = [];
    let temp = { value: null, has: null };
 ...
 * @return {any}
 */
export function arrayUnion(a, b, equalMethod) {
    let hash = get2ArrayOverlapMap(a, b, equalMethod);
 ...
 * @return {any}
 */
export function arrayIntersection(a, b, equalMethod) {
    let hash = get2ArrayOverlapMap(a, b, equalMethod);
    let re = [];
    let temp = { value: null, has: null };
    hash.forEach((value, key) => {
 ...
 * @return {any}
 */
export function arraySubtract(a, b, equalMethod) {
    let hash = get2ArrayOverlapMap(a, b, equalMethod);
    let re = [];
    let temp = { value: null, has: null };
    hash.forEach((value, key) => {
 ...
 * @return {boolean}
 */
function getOverlapMapItem(value, key, out) {
    let has;
    let raw;
 ...
 * @param equalMethod
 */
function get2ArrayOverlapMap(a, b, equalMethod) {
    let hash = new Map();
    const A_CODE = 1;
