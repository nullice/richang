 ...
 * @return {number}
 */
export function timeDiff(date, oldDate = new Date(), unit = "millisecond") {
 ...
 * @return {number}
 */
export function timeDiffDay(date, oldDate = new Date()) {
 ...
 * @return {number}
 */
export function timeDiffMinute(date, oldDate = new Date()) {
